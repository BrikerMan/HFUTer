...
- (void)start:(NSArray<SKDownload *> * _Nonnull)downloads;
- (void)pause:(NSArray<SKDownload *> * _Nonnull)downloads;
- (void)resume:(NSArray<SKDownload *> * _Nonnull)downloads;
- (void)cancel:(NSArray<SKDownload *> * _Nonnull)downloads;
@property (nonatomic, copy) BOOL (^ _Nullable shouldAddStorePaymentHandler)(SKPayment * _Nonnull, SKProduct * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable updatedDownloadsHandler)(NSArray<SKDownload *> * _Nonnull);
