...
SWIFT_MODULE_NAMESPACE_PUSH("Toaster")
@class ToastView;
...
+ (Toast * _Nonnull)makeText:(NSString * _Nonnull)text SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use 'init(text:)' instead.");
+ (Toast * _Nonnull)makeText:(NSString * _Nonnull)text duration:(NSTimeInterval)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use 'init(text:duration:)' instead.");
+ (Toast * _Nonnull)makeText:(NSString * _Nullable)text delay:(NSTimeInterval)delay duration:(NSTimeInterval)duration SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use 'init(text:delay:duration:)' instead.");
- (void)show;
- (void)cancel;
- (void)start;
- (void)main;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ToastWindow * _Nonnull shared;)
+ (ToastWindow * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
