...
+ (Toast * _Nonnull)makeText:(NSString * _Nonnull)text;
+ (Toast * _Nonnull)makeText:(NSString * _Nonnull)text duration:(NSTimeInterval)duration;
+ (Toast * _Nonnull)makeText:(NSString * _Nullable)text delay:(NSTimeInterval)delay duration:(NSTimeInterval)duration;
- (void)show;
- (void)cancel;
- (void)start;
- (void)main;
...
- (void)layoutSubviews;
- (UIView * _Nullable)hitTest:(CGPoint)point withEvent:(UIEvent * _Null_unspecified)event;
